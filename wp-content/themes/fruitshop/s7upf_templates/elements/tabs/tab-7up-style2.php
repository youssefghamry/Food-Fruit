...
<div class="tabs-block tab-7up-style2 <?php echo esc_attr($el_class)?> tab-ajax-<?php echo esc_attr($tab_ajax)?>">
    ...
    <div class="tab-header">
        ...
        ?>
        <ul class="ajax-title-tab title-tab-style2  <?php echo esc_attr($tab_align)?> list-inline-block">
            <?php
