...
<div class="vendor-order-order-css">
    <h2 class="title-order-order title18 text-uppercase font-bold"><?php printf( 'Orders for %s', wc_get_product( $product_id )->get_title() ); ?></h2>
            ...
            <tr>
                <td colspan="100%">
                    ...
                    <a href="#" class="order-comments-link">
                        <p>
                            <?php printf( esc_html__( 'Comments (%s)', 'fruitshop' ), count( $comments ) ); ?>
                        </p>
                    </a>
                    ...
                    <?php if ( class_exists( 'WC_Shipment_Tracking' ) ) : ?>
                        ...
                        <?php if ( is_array( $providers ) ) : ?>
                            ...
                            <a href="#" class="order-tracking-link">
                                <p>
                                    <?php esc_html_e( 'Shipping', 'fruitshop' ); ?>
                                </p>
                            </a>
