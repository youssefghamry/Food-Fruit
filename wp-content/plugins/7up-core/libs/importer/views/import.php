...
<br>
    ...
    <a href="#" onclick="return false" data-url="<?php echo admin_url('?7up_do_import=1&media=0') ?>" class="btn_stp_do_import button button-primary"><?php _e('Import Without Media',STP_TEXTDOMAIN)?></a>
<div id="import_debug">
</div>
<style>
    #import_debug{
